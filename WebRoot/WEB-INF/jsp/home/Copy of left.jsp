...
<!--                <li class="level2">
        ...
        <li class="level1">
            ...
            <ul style="display: none;" class="MenuLevel2">
                <li class="level2">
                    <div class="level2Style"><img src="style/images/MenuIcon/menu_arrow_single.gif" /> <a target="right" href="role_list.action"> 岗位管理</a></div>
                </li>
                
                <s:if test="#session.user.hasPrivilege('/department_list')">
                	<li class="level2">
                    	<div class="level2Style"><img src="style/images/MenuIcon/menu_arrow_single.gif" /> <a target="right" href="department_list.action"> 部门管理</a></div>
                	</li>
                </s:if>
                <s:else>
                	<li class="level2">
                    	<div class="level2Style"><img src="style/images/MenuIcon/menu_arrow_single.gif" /> <font color="gray"> 部门管理</font>></div>
                	</li>
                </s:else>
                
                <li class="level2">
                    <div class="level2Style"><img src="style/images/MenuIcon/menu_arrow_single.gif" /> <a target="right" href="user_list.action"> 用户管理</a></div>
                </li>
                <!--
                <li class="level2">
